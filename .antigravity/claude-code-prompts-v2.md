# DevHub Build Guide - Multi-Agent Workflow
...
✅ **DO:**
- Reference files by path (`project-constitution.md`)
...
1. ✅ `project-constitution.md` (technical specification)
2. ✅ `rules.md` (development rules & security guidelines)
...
I'm building "DevHub" - a browser-based developer utilities web app.

ATTACHED FILES:
1. project-constitution.md - Complete technical specification
2. rules.md - Development rules and security guidelines
...
1. Read project-constitution.md and rules.md thoroughly
...
2. project-constitution.md (reference)
3. rules.md (reference)
...
2. `project-constitution.md` (original spec)
...
✓ project-constitution.md (technical spec)
✓ rules.md (development rules, security, approved dependencies)
...
✅ Reference rules.md for all dependency and security decisions
...
2. project-constitution.md (confirm tech stack)
3. rules.md (confirm dependency rules)

STEP 2: Execute Phase 1 - Foundation (All tasks 1.1 - 1.4):

Tasks:
□ 1.1: Initialize Vite + React + TypeScript
□ 1.2: Install dependencies (verify against rules.md)
□ 1.3: Configure Tailwind + shadcn/ui
□ 1.4: Create folder structure

SECURITY CHECKPOINT (before installing):
- Verify each package is in rules.md approved list
...
- Follow rules.md TypeScript rules (no 'any', explicit returns)
...
✓ project-constitution.md (Tool requirements section)
✓ rules.md (TypeScript rules, security rules)
...
✓ project-constitution.md
✓ rules.md (check jwt-decode library version)
...
- Use `jwt-decode` library (verify version in rules.md)
...
✓ project-constitution.md
✓ rules.md (check uuid library version)
...
- Use `uuid` library v4() (check rules.md version)
...
✓ project-constitution.md (PWA Requirements section)
✓ rules.md (check vite-plugin-pwa version)
...
✓ project-constitution.md (Performance Targets)
...
✓ project-constitution.md (for requirements)
...
- Follow rules.md security guidelines
...
CONTEXT: DevHub is complete. Adding new tool: [TOOL_NAME]

REFERENCES:
✓ Follow existing pattern from Base64/JWT/UUID
✓ project-constitution.md (Tool requirements)
✓ rules.md (TypeScript, security, dependencies)
...
4. Libraries needed: [Check rules.md approved list first]
